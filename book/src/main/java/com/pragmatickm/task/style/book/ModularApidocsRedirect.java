 ...
 * along with pragmatickm-task-style.  If not, see <https://www.gnu.org/licenses/>.
 */

package com.pragmatickm.task.style.book;
...
@WebServlet("/task/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/task/style/apidocs/com.pragmatickm.task.style/com" + Objects.toString(req.getPathInfo(), ""),
